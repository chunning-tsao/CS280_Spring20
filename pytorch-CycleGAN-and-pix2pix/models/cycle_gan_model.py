...
class CycleGANModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.loss_names = ['D_A', 'G_A', 'cycle_A', 'idt_A', 'D_B', 'G_B', 'cycle_B', 'idt_B', 'temp_fake_A', 'temp_rec_B']
        ...
        if self.isTrain:
            ...
            self.criterionTemp = temporal_loss
    ...
    def backward_G(self):
        ...
        # Add temporal loss
        self.loss_temp_fake_A = self.criterionTemp(self.fake_A[:-1], self.warp_fake_A[1:], self.confidences[1:]).detach()
        self.loss_temp_rec_B = self.criterionTemp(self.rec_B[:-1], self.warp_rec_B[1:], self.confidences[1:]).detach()

        # combined loss and calculate gradients
        self.loss_G = self.loss_G_A + self.loss_G_B + self.loss_cycle_A + self.loss_cycle_B + self.loss_idt_A + self.loss_idt_B\
                    + self.loss_temp_fake_A + self.loss_temp_rec_B
